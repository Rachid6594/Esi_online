"""
Service RessourceCours : logique métier.
"""
from app.espace_prof.repositories.ressourcecours_repository import RessourceCoursRepository
from app.core.exceptions import NotFoundError, ValidationError


class RessourceCoursService:
    def __init__(self):
        self.repository = RessourceCoursRepository()
    ...
    def get_or_raise(self, pk: int):
        ...
        if obj is None:
            raise NotFoundError(f"RessourceCours avec id={pk} introuvable.")
        return obj
