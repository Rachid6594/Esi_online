"""
Service FichierSupportTP : logique métier.
"""
from app.espace_prof.repositories.fichiersupporttp_repository import FichierSupportTPRepository
from app.core.exceptions import NotFoundError, ValidationError


class FichierSupportTPService:
    def __init__(self):
        self.repository = FichierSupportTPRepository()
    ...
    def get_or_raise(self, pk: int):
        ...
        if obj is None:
            raise NotFoundError(f"FichierSupportTP avec id={pk} introuvable.")
        return obj
