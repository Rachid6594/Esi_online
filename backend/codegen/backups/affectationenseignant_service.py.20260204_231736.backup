"""
Service AffectationEnseignant : logique métier.
"""
...
class AffectationEnseignantService:
    def __init__(self):
        self.repository = AffectationEnseignantRepository()
    ...
    def get_or_raise(self, pk: int):
        ...
        if obj is None:
            raise NotFoundError(f"AffectationEnseignant avec id={pk} introuvable.")
        return obj
