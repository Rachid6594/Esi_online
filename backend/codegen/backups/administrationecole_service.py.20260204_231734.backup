"""
Service AdministrationEcole : logique métier.
"""
from app.administration.repositories.administrationecole_repository import AdministrationEcoleRepository
from app.core.exceptions import NotFoundError, ValidationError


class AdministrationEcoleService:
    def __init__(self):
        self.repository = AdministrationEcoleRepository()
    ...
    def get_or_raise(self, pk: int):
        ...
        if obj is None:
            raise NotFoundError(f"AdministrationEcole avec id={pk} introuvable.")
        return obj
