...
class AnneeAcademique(models.Model):
    ...
    created_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='annees_creees')
    updated_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='annees_modifiees')
...
class Classe(models.Model):
    ...
    created_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='classes_creees')
...
class Annonce(models.Model):
    ...
    auteur = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='annonces_creees')
...
class LectureAnnonce(models.Model):
    ...
    user = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='annonces_lues')
...
class EmploiDuTemps(models.Model):
    ...
    created_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='edt_crees')
...
class Evenement(models.Model):
    ...
    created_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='evenements_crees')
...
class AffectationEnseignant(models.Model):
    ...
    created_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='affectations_creees')
...
class Ressource(models.Model):
    ...
    uploaded_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='ressources_uploadees')
...
class ConsultationRessource(models.Model):
    ...
    user = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='consultations')
...
class Emprunt(models.Model):
    ...
    emprunteur = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='emprunts')
    ...
    enregistre_par = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='emprunts_enregistres')
...
class Reservation(models.Model):
    ...
    utilisateur = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='reservations')
...
class Message(models.Model):
    ...
    expediteur = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='messages_envoyes')
    destinataire = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='messages_recus')
...
class Forum(models.Model):
    ...
    created_by = models.ForeignKey(null=True, to='app_admin.User', on_delete=models.SET_NULL, related_name='forums_crees')
...
class Sujet(models.Model):
    ...
    titre = models.CharField(max_length=300)
    contenu = models.TextField()
    auteur = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='sujets_crees')
...
class Reponse(models.Model):
    ...
    contenu = models.TextField()
    auteur = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='reponses_forum')
...
class ReactionReponse(models.Model):
    ...
    user = models.ForeignKey(to='app_admin.User', on_delete=models.CASCADE, related_name='reactions')
