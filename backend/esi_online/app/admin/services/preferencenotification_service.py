"""
Service PreferenceNotification : logique métier.
"""
...
class PreferenceNotificationService:
    def __init__(self):
        self.repository = PreferenceNotificationRepository()
    ...
    def get_or_raise(self, pk: int):
        ...
        if obj is None:
            raise NotFoundError(f"PreferenceNotification avec id={pk} introuvable.")
        return obj
