...
class QuestionQCMService:
    ...
    def get_or_raise(self, pk: int):
        ...
        if obj is None:
            raise NotFoundError(f"QuestionQCM avec id={pk} introuvable.")
        return obj
